...
class Trainer(object):
    def __init__(self, args):
        ...
        # Define Optimizer
        optimizer = optim.SGD(train_params, momentum=args.momentum, weight_decay=args.weight_decay, nesterov=args.nesterov)

        # Define Criterion
        # whether to use class balanced weights
        if args.use_balanced_weights:
            classes_weights_path = os.path.join(args.dataset_name, args.dataset_name+'_classes_weights.npy')
...
def main():
    ...
    parser.add_argument("--dataset_name", type=str, default="pascal", choices=["pascal", "coco"], help="dataset name (default: pascal)")
    parser.add_argument("--dataset_dir", type=str, default=None, help="dataset path directory consists of (train, val, test)")
    ...
    parser.add_argument("--checkdir", type=str, default="./checkpoints", help="checkpoint directory")
    ...
    if args.epochs is None:
        ...
        args.epochs = epoches[args.dataset_name.lower()]
